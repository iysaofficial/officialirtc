...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "International Research Teacher Competition - Online Competition":
        ...
        break;
      case "International Research Teacher Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$200 USD");
        break;
      case "International Research Teacher Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  useEffect(() => { 
    ...
    if (!termsAccepted) {
      ...
      router("/homeinter"); // Navigasi ke halaman HomeIndo
    }
  }, [router]);

  const scriptURL = "https://script.google.com/macros/s/AKfycbyiIOHC2PB3Ig7KO8JtM3qLEDlOfhyXfgDmWV1sKu7OrMm74DdTbqdkaOPPygoxNXKyHQ/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO IRTC 2026 PARTICIPANTS, Please consider the following
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="International Research Teacher Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="International Research Teacher Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                <div class="input-box">
                  ...
                  <label>
                    <p>
                      ...
                      https://www.instagram.com/irtc_official/) or write your
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    IRTC 2026 Competition Information Resources
                  </label>
                  <select
                    type="text"
