...
function IndonesiaOffline() {
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      ...
      router("/homeindo"); // Navigate to the HomeIndo page
    }
  }, [router]);

  const scriptURL = "https://script.google.com/macros/s/AKfycbzqATjjLfle74PcikNSOw-bQcjwMWolSeuOi5y6lhlWi-yEt2oJXLU3vcoCjo-vPvIC/exec";
